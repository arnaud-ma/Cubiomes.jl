...
@testset "Octaves" begin
    ...
    @testset "show" begin
        ...
        @test repr(MIME"text/plain"(), noise) == """
            ...
            ├ Total amplitude: 1.0
            ├ Octave 1: amplitude=0.142857 (14.3%), lacunarity=0.25
            ├ Octave 2: amplitude=0.285714 (28.6%), lacunarity=0.125
            └ Octave 3: amplitude=0.571429 (57.1%), lacunarity=0.0625"""
    end
end
...
@testset "Double perlin" begin
    ...
    @testset "Show" begin
        ...
        @test repr(MIME"text/plain"(), noise) == """
            ...
            │ ├ Octave 1: amplitude=2.289328 (35.2%), lacunarity=0.03125
            │ ├ Octave 2: amplitude=2.706967 (41.6%), lacunarity=0.0625
            │ ├ Octave 3: amplitude=1.180355 (18.2%), lacunarity=0.125
            │ └ Octave 4: amplitude=0.324807 (5.0%), lacunarity=0.25
            └ Octave Group B:
              ├ Total amplitude: 6.5015
              ├ Octave 1: amplitude=2.289328 (35.2%), lacunarity=0.03125
              ├ Octave 2: amplitude=2.706967 (41.6%), lacunarity=0.0625
